...
RSpec.describe "API V1 Movies", type: 'request' do
  ...
  #       puts json_response
  #       expect(json_response.keys).to match_array(["id", "name", "user_id", "preview_video_url", "runtime", "synopsis", "created_at", "updated_at"])
  #     end
  #   end
  ...
  #     json_response = JSON.parse(response.body)
  #     puts json_response
  #     expect(json_response[0].keys).to match_array(["id", "name", "user_id", "preview_video_url", "runtime", "synopsis", "created_at", "updated_at"])
  #   end
  # end
